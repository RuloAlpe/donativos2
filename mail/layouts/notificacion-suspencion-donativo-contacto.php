...
<!--[if mso]></td></tr></table><![endif]-->
	...
	<div style="line-height:200%;color:#555555;font-family:'Droid Serif', Georgia, Times, 'Times New Roman', serif; padding-right: 10px; padding-left: 10px; padding-top: 5px; padding-bottom: 10px;">	
		<div style="font-size:12px;line-height:24px;font-family:'Droid Serif', Georgia, Times, 'Times New Roman', serif;color:#555555;text-align:left;"><p style="margin: 0;font-size: 14px;line-height: 28px;text-align: center"><strong><span style="font-size: 24px; line-height: 48px;">
            El donante: <?= $nombre ?> suspendio su donación mensual</span></strong></p></div>	
	</div>
	<!--[if mso]></td></tr></table><![endif]-->
</div>
	...
	<div style="line-height:200%;color:#555555;font-family:'Droid Serif', Georgia, Times, 'Times New Roman', serif; padding-right: 10px; padding-left: 50px; padding-top: 10px; padding-bottom: 10px;">	
		<div style="line-height:24px;font-size:12px;color:#555555;font-family:'Droid Serif', Georgia, Times, 'Times New Roman', serif;text-align:left;"><p style="margin: 0;line-height: 24px;text-align: left;font-size: 12px"><span style="font-size: 16px; line-height: 32px;">
            Se puede contactar por medio de su email: <?= $contacto ?></span></p>

            <p style="margin: 0;line-height: 24px;text-align: left;font-size: 12px"><span style="font-size: 16px; line-height: 32px;">
            Su motivo fue: <?= $motivo ?></span></p>
           <p style="margin: 0;font-size: 12px;line-height: 24px;text-align: left">&#160;<br></p></div>	
	</div>
	<!--[if mso]></td></tr></table><![endif]-->
</div>
