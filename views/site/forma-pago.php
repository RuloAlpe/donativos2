  ...
  <div class="container container-column container-full">
    <div class="tipos-de-pago-content">
      ...
      <div class="tipos-de-pago">
        <div class="pagocard">
          <a data-value="2" data-tarjeta="0" data-tokenoc="<?=$tokenOc?>" data-token="tp_3922b05cccd499fb9d2c415038ab9c08571112b938d1d" class="btn-tipo-de-pago js-btn-pago"><img src="<?=Url::base()?>/webassets/images/logo-openpay.png" alt=""></a><span class="caption">Pago en establecimiento</span>
          <a data-value="2" data-tarjeta="1" data-tokenoc="<?=$tokenOc?>" data-token="tp_3922b05cccd499fb9d2c415038ab9c08571112b938d1d" class="btn-tipo-de-pago js-btn-pago"><img src="<?=Url::base()?>/webassets/images/logo-openpay.png" alt=""></a><span class="caption">Pago con tarjeta</span>
        </div>
      </div>
    </div>
  </div>
