...
class Utils {
	...
	public function sendPagoNotificacion($email, $parametrosEmail) {
		// Envia el correo electronico
		return $this->sendEmail ( '@app/mail/layouts/notificacion-compra.php', '@app/mail/layouts/notificacion-compra-text.php', 'development@2gom.com.mx', $email, 'Notificación de donativo.', $parametrosEmail );
	}
